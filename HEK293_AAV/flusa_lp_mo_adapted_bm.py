...
models = [lp_mo_4_model, lp_mo_24_model, lp_mo_48_model, lp_mo_72_model]
...
model_names = ["lp_mo_4_model", "lp_mo_24_model", "lp_mo_48_model",  
               "lp_mo_72_model"]
...
# LP MO 4
#selected_column = "lp_mo_4"
#cstr_lp_mo_4_model = mu_qp_constraining(lp_mo_4_model, selected_column)
#cstr_lp_mo_4_model.solver = "cplex"
#cstr_lp_mo_4_model.solver.configuration.tolerances.feasibility = 1e-8

#file_path = "/home/users/lzehetner/data/paper4_aav/HEK_AAV/flux_sampling/adapted_bm/flux_samples_lp_mo_4.csv"
#flux_samples = pd.read_csv(file_path)

#print("Flux sampling (LP-MO-4) started...")

#optgp = OptGPSampler(cstr_lp_mo_4_model, processes=10)
...
#        sample_df = pd.DataFrame(s2, columns=cstr_lp_mo_4_model.reactions.list_attr("id"))
...
#cstr_lp_mo_4_model.reactions.MAR13082.upper_bound = 1000
#cstr_lp_mo_4_model.reactions.MAR13082.lower_bound = 0

#print("Flux sampling done.")
#print("Loop correction starts ...")
#start_time = time.time()
#results = calculate_loopless_fluxes(cstr_lp_mo_4_model, flux_samples)
#end_time = time.time()
#elapsed_time = end_time - start_time
#print(elapsed_time)
...
#flux_samples.to_csv("/home/users/lzehetner/data/paper4_aav/HEK_AAV/flux_sampling/adapted_bm/flux_samples_lp_mo_4.csv", index=False)
#flux_distributions_df.to_csv("/home/users/lzehetner/data/paper4_aav/HEK_AAV/flux_sampling/adapted_bm/loopless_flux_samples_lp_mo_4.csv", index = False)
#solver_results_df.to_csv("/home/users/lzehetner/data/paper4_aav/HEK_AAV/flux_sampling/adapted_bm/solver_status_lp_mo_4.csv", index = False)


# LP MO 24
#selected_column = "lp_mo_24"
#cstr_lp_mo_24_model = mu_qp_constraining(lp_mo_24_model, selected_column)
#cstr_lp_mo_24_model.solver = "cplex"
#cstr_lp_mo_24_model.solver.configuration.tolerances.feasibility = 1e-8

#file_path = "/home/users/lzehetner/data/paper4_aav/HEK_AAV/flux_sampling/adapted_bm/flux_samples_lp_mo_24.csv"
#flux_samples = pd.read_csv(file_path)

#print("Flux sampling (LP-MO-24) started...")

#optgp = OptGPSampler(cstr_lp_mo_24_model, processes=10)
...
#        s2 = optgp.sample(sample_count)
        ...
        # Convert the samples to a DataFrame
#        sample_df = pd.DataFrame(s2, columns=cstr_lp_mo_24_model.reactions.list_attr("id"))
...
#cstr_lp_mo_24_model.reactions.MAR13082.upper_bound = 1000
#cstr_lp_mo_24_model.reactions.MAR13082.lower_bound = 0

#start_time = time.time()
#results = calculate_loopless_fluxes(cstr_lp_mo_24_model, flux_samples)
#end_time = time.time()
#elapsed_time = end_time - start_time
#print(elapsed_time)
#flux_distributions_df = results[0]
...
#flux_samples.to_csv("/home/users/lzehetner/data/paper4_aav/HEK_AAV/flux_sampling/adapted_bm/flux_samples_lp_mo_24.csv", index=False)
#flux_distributions_df.to_csv("/home/users/lzehetner/data/paper4_aav/HEK_AAV/flux_sampling/adapted_bm/loopless_flux_samples_lp_mo_24.csv", index = False)
#solver_results_df.to_csv("/home/users/lzehetner/data/paper4_aav/HEK_AAV/flux_sampling/adapted_bm/solver_status_lp_mo_24.csv", index = False)

# LP MO 48
selected_column = "lp_mo_48"
cstr_lp_mo_48_model = mu_qp_constraining(lp_mo_48_model, selected_column)
cstr_lp_mo_48_model.solver = "cplex"
cstr_lp_mo_48_model.solver.configuration.tolerances.feasibility = 1e-8

file_path = "/home/users/lzehetner/data/paper4_aav/HEK_AAV/flux_sampling/adapted_bm/flux_samples_lp_mo_48.csv"
flux_samples = pd.read_csv(file_path)

#print("Flux sampling (LP-MO-48) started...")

#optgp = OptGPSampler(cstr_lp_mo_48_model, processes=10)
...
#        s2 = optgp.sample(sample_count)
        ...
        # Convert the samples to a DataFrame
#        sample_df = pd.DataFrame(s2, columns=cstr_lp_mo_48_model.reactions.list_attr("id"))
...
cstr_lp_mo_48_model.reactions.MAR13082.upper_bound = 1000
cstr_lp_mo_48_model.reactions.MAR13082.lower_bound = 0

start_time = time.time()
results = calculate_loopless_fluxes(cstr_lp_mo_48_model, flux_samples)
end_time = time.time()
elapsed_time = end_time - start_time
print(elapsed_time)
flux_distributions_df = results[0]
...
#flux_samples.to_csv("/home/users/lzehetner/data/paper4_aav/HEK_AAV/flux_sampling/adapted_bm/flux_samples_lp_mo_48.csv", index=False)
flux_distributions_df.to_csv("/home/users/lzehetner/data/paper4_aav/HEK_AAV/flux_sampling/adapted_bm/loopless_flux_samples_lp_mo_48.csv", index = False)
solver_results_df.to_csv("/home/users/lzehetner/data/paper4_aav/HEK_AAV/flux_sampling/adapted_bm/solver_status_lp_mo_48.csv", index = False)

# LP MO 72
selected_column = "lp_mo_72"
cstr_lp_mo_72_model = mu_qp_constraining(lp_mo_72_model, selected_column)
cstr_lp_mo_72_model.solver = "cplex"
cstr_lp_mo_72_model.solver.configuration.tolerances.feasibility = 1e-8

file_path = "/home/users/lzehetner/data/paper4_aav/HEK_AAV/flux_sampling/adapted_bm/flux_samples_lp_mo_72.csv"
flux_samples = pd.read_csv(file_path)

#print("Flux sampling (LP-MO-72) started...")

#optgp = OptGPSampler(cstr_lp_mo_72_model, processes=10)
...
#        s2 = optgp.sample(sample_count)
        ...
        # Convert the samples to a DataFrame
#        sample_df = pd.DataFrame(s2, columns=cstr_lp_mo_72_model.reactions.list_attr("id"))
...
cstr_lp_mo_72_model.reactions.MAR13082.upper_bound = 1000
cstr_lp_mo_72_model.reactions.MAR13082.lower_bound = 0

start_time = time.time()
results = calculate_loopless_fluxes(cstr_lp_mo_72_model, flux_samples)
end_time = time.time()
elapsed_time = end_time - start_time
print(elapsed_time)
flux_distributions_df = results[0]
...
#flux_samples.to_csv("/home/users/lzehetner/data/paper4_aav/HEK_AAV/flux_sampling/adapted_bm/flux_samples_lp_mo_72.csv", index=False)
flux_distributions_df.to_csv("/home/users/lzehetner/data/paper4_aav/HEK_AAV/flux_sampling/adapted_bm/loopless_flux_samples_lp_mo_72.csv", index = False)
solver_results_df.to_csv("/home/users/lzehetner/data/paper4_aav/HEK_AAV/flux_sampling/adapted_bm/solver_status_lp_mo_72.csv", index = False)
